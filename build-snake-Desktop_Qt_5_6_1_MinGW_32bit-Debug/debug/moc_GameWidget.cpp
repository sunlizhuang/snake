...
QT_MOC_LITERAL(6, 55, 9), // "upbtnSlot"
QT_MOC_LITERAL(7, 65, 11), // "leftbtnSlot"
QT_MOC_LITERAL(8, 77, 12), // "rightbtnSlot"
QT_MOC_LITERAL(9, 90, 11), // "downbtnSlot"
QT_MOC_LITERAL(10, 102, 12), // "startbtnSlot"
QT_MOC_LITERAL(11, 115, 13), // "returnbtnSlot"
QT_MOC_LITERAL(12, 129, 11) // "timeoutSlot"

    },
    "GameWidget\0UpSignal\0\0DownSignal\0"
    "LeftSignal\0RightSignal\0upbtnSlot\0"
    "leftbtnSlot\0rightbtnSlot\0downbtnSlot\0"
    "startbtnSlot\0returnbtnSlot\0timeoutSlot"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->leftbtnSlot(); break;
        case 6: _t->rightbtnSlot(); break;
        case 7: _t->downbtnSlot(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWidget::UpSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (GameWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWidget::DownSignal)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (GameWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWidget::LeftSignal)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (GameWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWidget::RightSignal)) {
                *result = 3;
                return;
            }
        }
